...
class Container_333ae4d539 extends _PHPStan_dcc7b7cff\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'level' => 4,
			'paths' => ['/Users/atmonshi/Sites/zeus/core/src', '/Users/atmonshi/Sites/zeus/core/config'],
			'exceptions' => [
				'implicitThrows' => true,
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_333ae4d539 $container)
			{
	...
	public function createServiceContainer(): Container_333ae4d539
	{
		return $this;
	}
