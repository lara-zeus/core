...
<div
     ...
     x-data="{ value: @entangle($field['fieldName']), picker: undefined }"
...
>
    ...
    <input type="{{ $field['type'] ?? 'text' }}"
           ...
           id="{{ $field['fieldName'] ?? '' }}"
           class="{{ $field['class'] ?? '' }} {{ $field->all_rules }} block w-full px-4 py-2 text-gray-700 text-sm leading-5 bg-white border border-gray-300 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:outline-none focus:border-green-200 transition duration-150 ease-in-out"
           value=""
