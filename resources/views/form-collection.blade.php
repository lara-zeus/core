<div>
    @if(isset($options) && $options)
        ...
        <x-zeus::elements.link target="_blank" href="{{ route('bolt.admin.collections') }}" data-tippy-content="Manage Lists">
            <x-heroicon-o-cog class="h-5 w-5 text-green-600 mt-1" />
        </x-zeus::elements.link>
    @else
        <x-zeus::elements.button-link wire:click="addCollection" data-tippy-content="Add New List">
